# -*- coding: utf-8 -*-
"""
Django settings for Task Board project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'task_board.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Alexander Kaluzhny""", 'alexander.kaluzhny@gmail.com'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///task_board'),
}
...
SOCIALACCOUNT_ADAPTER = 'task_board.users.adapters.SocialAccountAdapter'
